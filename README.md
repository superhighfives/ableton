...
- **ambient** — create or select a **MIDI track**, right-click it → **Generate
  ...
  **Rhythm** (a Euclidean pulse), **Bass** (a tonic bass loop), **Play** (an
  armed, ready-to-play instrument), or **Perform** (a Push-ready rig composing
  them all) — then **Generate**. It builds the tracks, scenes, clips and an
  optional reverb/delay chain; switch to Session view (Tab) to launch them. See
  [ambient/README.md](ambient/README.md).
