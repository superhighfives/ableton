...
- **ambient** — create or select a **MIDI track**, right-click it → **Generate
  ...
  probability-scattered shimmer), **Play** (an armed, ready-to-play instrument),
  or **Perform** (a Push-ready rig composing all four) — then **Generate**. It
