...
- **ambient** — create or select a **MIDI track**, right-click it → **Generate
  ...
  **Rhythm** (drum patterns on a Drum Rack), **Bass** (a bass loop that follows
  ...
  Push-ready rig of sectioned scenes composing them all) — then **Generate**. It
